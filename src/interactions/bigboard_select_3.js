...
export async function execute(interaction) {
    ...
    console.log('Bigboard select 3 debug: Selected value (raw):', interaction.values[0]);
    console.log('Bigboard select 3 debug: Selected value (normalized):', normalizedSelected);
    console.log('Bigboard select 3 debug: All normalized player names:', players.map(p => normalize(p.name)));
    console.log('Bigboard select 3 debug: All raw player names:', players.map(p => p.name));
